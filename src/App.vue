...
const appTitle = computed(() =>
  store.apiKind === "SSC" ? "Subway Surfers City" : "Subway Surfers",
);
</script>
  ...
  <div class="text-white font-sans min-h-screen block lg:flex">
    <div class="lg:hidden flex items-center justify-between bg-[#09090b] p-4">
      <a href="#" class="cursor-pointer flex items-center gap-2">
        <span class="font-bold text-white text-xl">{{ appTitle }}</span>
      </a>
      <button
    ...
    <div class="lg:hidden">
      <div
        :class="[
          'fixed inset-0 z-40 transition-opacity duration-200 bg-black',
          showMobileSidebar
